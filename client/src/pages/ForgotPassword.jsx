      ...
      <div className="flex flex-col justify-center md:flex-row h-screen">
        ...
        <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tr-[80px] rounded-br-[80px]">
          <div className="text-center h-[450px]">
            ...
            <h3 className="text-gray-300  mb-12 max-w-[320ox] mx-auto text-3xl font-medium leading-10 ">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
          ...
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleForgotPassword}>
              ...
              <button
                type="submit"
                className="border-2 mt-5 border-black w-full font-semibold bg-black text-white py-2 rounded hover:bg-white hover:text-black transition"
